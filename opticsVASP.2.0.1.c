...
do
fscanf(vasprun,"%s",str);                                      /*posiciona o ponteiro após a palavra NOMEGA*/
...
do
fscanf(vasprun,"%s",str);                                      /*posiciona o ponteiro após a palavra <dielectricfunction>*/
while(strcmp(str,"<dielectricfunction>")!=0);

do
fscanf(vasprun,"%s",str);                                      /*posiciona o ponteiro após a palavra <imag>*/
while(strcmp(str,"<imag>")!=0);

do
fscanf(vasprun,"%s",str);                                      /*posiciona o ponteiro após a palavra <set>*/
...
do
fscanf(vasprun,"%s",str);                                      /*posiciona o ponteiro após a palavra <real>*/
